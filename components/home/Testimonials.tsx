...
const testimonials = [
    {
        ...
        role: "Eco Enthusiast",
        avatar: "/placeholder-avatar-1.jpg" // We'll just use a placeholder color in CSS or standard image
    },
    {
        id: 2,
        ...
        <section className="py-16 container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className="bg-[#fcf9f2] p-8 rounded-2xl relative">
                        ...
                        <p className="text-foreground italic mb-6 text-sm leading-relaxed">
                            &quot;{testimonial.text}&quot;
                        </p>
